...
// at block height 592322 on 2026-08-04 via the `representatives` RPC. Includes
// every representative holding >= 1e36 raw.
//
// Upstream shipped this list EMPTY with max_blocks_live set to the Nano mainnet
// height. Because XRO's ~592K-block ledger never reaches that height, the node
// stays permanently in bootstrap-weight mode (ledger::weight() consults this map
// before the ledger) while the map itself holds nothing. A node with a complete
// ledger is unaffected - weight() falls through to real ledger weights on a miss
// - but a bootstrapping node has no ledger weights yet, leaving it with zero
// trust anchors and unable to establish quorum. That is the documented
// "fresh nodes cannot bootstrap" failure.
std::vector<std::pair<std::string, std::string>> preconfigured_weights_live = {
	{ "xro_17xnzfitcg476uezh5ttso54f3i674hynr88jynoyonoi3i6a5ncrh6xd9tj", "67825650062379876882159091900686466290" },
	{ "xro_3qn4pwex9bx3jy34jg6ogxxngwq3fmb13trs78weybwbe9fg5msgehj9qrcn", "25074621314256516388122782858543561320" },
	{ "xro_3z4u1upq8e798pj669tki5osyit6jmyzwn6cba56pnsp77hna8ze9gku93np", "23405223385682928015917333701525037300" },
	...
	{ "xro_1nanswapnscbjjr6nd8bjbyp7o3gby1r8m18rbmge3mj8y5bihh71sura9dx", "17818534999638332761490902248717164899" },
	{ "xro_1mnkyfrnzq1tkspbyc3kztcg31tkif3ets4ktwsbp6567z4c11u3b94jez9z", "8850084951581000000000000000000000000" },
	...
	{ "xro_1m1nzthjrr975sjy5yzteqikecu16bgmsikdschskjzhht98761e7qu15eae", "7953327437167339214558567316746788754" },
	{ "xro_3fishntjrycmdnhxxf8stcxfo7jks4ba1hqf8tt9bq51kech65hrq8ttng4e", "7058613049559000005420000000000000000" },
	{ "xro_1txsbyfk645bjjuiooig9m1egrjiw4mzuwp77io3b95k1mdnp868rui6w3b1", "5892590131413010598810197268579571712" },
	{ "xro_1rfb48bj9tr6a95whcruebi458359afktmzqfoa687q1i5om7gthstpfyf3c", "5070217509519142579447458096803886080" },
	...
	{ "xro_3hpcjgfzi81pixy4pkr3p4ngyq1sdi3arirfngjgbwno6zj4c19kt18r1q8t", "1496840019408423113537832165406500738" },
};
...
uint64_t max_blocks_live = 600000;
}
